...
class m660kn extends StatelessWidget {
  @override
          ...
          children: <Widget>[
              ...
              items: [
                ...
                Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage(
                          "https://coolermed.com/wp-content/uploads/2021/05/coolermed-m660kn-kan-muhafaza-dolap-2.jpg"),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                ...
                Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage(
                          "https://coolermed.com/wp-content/uploads/2021/05/coolermed-m660kn-kan-muhafaza-dolap-ozellikler-2.jpg"),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
            ...
            DataTable(
              ...
              rows: [
                ...
                DataRow(cells: [
                  DataCell(Text('Drawers',
                      style: TextStyle(
                          fontSize: 13, fontWeight: FontWeight.bold))),
                  DataCell(Text('6 pcs')),
                ]),
                DataRow(cells: [
                  DataCell(Text('Blood Bag',
                      style: TextStyle(
                          fontSize: 13, fontWeight: FontWeight.bold))),
                  DataCell(Text('360 pcs')),
                ]),
                DataRow(cells: [
